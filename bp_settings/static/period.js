...
function load_data(e) {
    if (e.offsetX > this.offsetWidth) {
        ...
        document.querySelector('input[name="period_desc"]').value = this.children[1].innerHTML
        document.querySelector('input[name="period_duration"]').value = this.children[2].innerHTML
