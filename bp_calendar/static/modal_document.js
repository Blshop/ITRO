...
let document_type = document.querySelector('select[name="document_type"]')
...
function activate_add() {
    console.log(unit_f, document_type_f, end_date_f, file_f)
    if (unit_f && document_type_f && end_date_f && file_f && period_f) {
